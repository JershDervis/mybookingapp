...
import { defaultSchema, type DbClient, type DefaultSchema } from '$lib/database/db';
import type { Adapter } from '@auth/core/adapters';

// eslint-disable-next-line @typescript-eslint/no-empty-interface
interface CustomSchema extends DefaultSchema {}

export function pgDrizzleAdapter(client: DbClient, schema?: Partial<CustomSchema>): Adapter {
